            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        {
                            $sql = "insert into product_details values('$proid','$name','$source','$date','$status','$amount','$weight','$desc')";
                            ...
                            <div class="form">
                                <form class="cmxform form-horizontal " id="signupForm" method="POST" action="<?php echo ($_SERVER["PHP_SELF"]); ?>"  novalidate="novalidate">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="firstname" name="Product_id" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label col-lg-3">Name</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="lastname" name="Product_name" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label col-lg-3">Source</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="username" name="Source" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label  class="control-label col-lg-3">Date</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="password" name="PDate" type="text" placeholder="yyyy-mm-dd">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label col-lg-3">Status</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="confirm_password" name="Pro_status" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label col-lg-3">Amount</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="email" name="Pamount" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label col-lg-3">Weight</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="email" name="Pweight" type="number">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label col-lg-3">Description</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="email" name="Pdescription" type="textarea">
                                        </div>
                                    </div>
                                    <!--<div class="form-group ">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                            <button class="btn btn-primary" type="submit" name="addpro">Add Product</button>
                                            <!--<button class="btn btn-default" type="button">Cancel</button>-->
                                        </div>
                                    </div>
                                </form>
