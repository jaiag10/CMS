            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        {
                            $sql = "insert into customer_details values('$custid','$name','$mob','$address','$city','$state','$pin','$email','$DOB')";
                            ...
                            <div class="form">
                                <form class="cmxform form-horizontal " id="signupForm" method="POST" action="<?php echo ($_SERVER["PHP_SELF"]); ?>" novalidate="novalidate">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="firstname" name="Cust_id" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label col-lg-3">Name</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="lastname" name="Cust_name" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label col-lg-3">Mobile no.</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="username" name="mob" type="number" maxlength="10">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control " id="confirm_password" name="City" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label col-lg-3">State</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="email" name="State" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label col-lg-3">Pincode</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="email" name="pincode" type="number">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label col-lg-3">Email</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="email" name="cust_email" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                            <button class="btn btn-primary" type="submit" name="addcust">Add Customer</button>
                                            <!--<button class="btn btn-default" type="button">Cancel</button>-->
                                        </div>
                                    </div>
                                </form>
