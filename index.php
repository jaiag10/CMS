...
<meta name="keywords" content="Courier management system,CMS,logistics,shipping" />
			...
			<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							<li><a href="index.html" class="hvr-bounce-to-bottom active">Home</a></li>
							...
							<li><a href="#" class="hvr-bounce-to-bottom scroll" data-toggle="modal" data-target="#myModal2">Order info</a></li>
				...
				<ul class="rslides" id="slider3">
					<li>
						<div class="banner-text">
							<h3>Manage your Shipping with us</h3>
					...
					<li>
						<div class="banner-text">
							<h3>Detailed Shipping information</h3>
							<!--<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem ab illo.</p>-->
						</div>
					</li>
					<li>
						<div class="banner-text">
							<h3>Enjoy great door-to-door service </h3>
							<!--<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem ab illo.</p>-->
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h5>Manage your business with us</h5>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>Order info</h4>
										<img src="images/g1.jpg" alt=" " class="img-responsive">
										<h5>Enter your order id</h5>
										
										<form action ="form.php" method="POST">
										<input type="text" name="orderinfo" required>
										<br>
										<input type="Submit" name="submit" value="Get order Detail">
										</form>
									</div>
								</div>
							</div>
	...
	<div class="about" id="about">
		...
		<h3 class="heading-agileinfo">About us</h3>
			...
			<div class="col-md-6 banner_bottom_left">
				<h3>We Are dedicated towards perfection</h3>
				...
				<div class="wthree_more wthree_more1">
					<a href="#" class="hvr-bounce-to-bottom scroll" data-toggle="modal" data-target="#myModal2">Read More</a>
				</div>
			</div>
			<div class="clearfix"> </div>
		</div>
	...
	<div class="stats-agileits" id="stats">
		...
		<div class="stats-info agileits w3layouts">
			<div class="col-md-6 agileits w3layouts col-sm-6 stats-grid stats-grid-1">
				<div class="numscroller agileits-w3layouts" data-slno='1' data-min='0' data-max='400' data-delay='3' data-increment="2">400</div>
			...
			<div class="col-md-6 col-sm-6 agileits w3layouts stats-grid stats-grid-2">
				<div class="numscroller agileits-w3layouts" data-slno='1' data-min='0' data-max='600' data-delay='3' data-increment="2">600</div>
				<div class="stat-info-w3ls">
			...
			<div class="col-md-6 col-sm-6 stats-grid agileits w3layouts stats-grid-3">
				<div class="numscroller agileits-w3layouts" data-slno='1' data-min='0' data-max='3' data-delay='3' data-increment="2">3</div>
				<div class="stat-info-w3ls">
			...
			<div class="col-md-6 col-sm-6 stats-grid stats-grid-4 agileits w3layouts">
				...
				<div class="stat-info-w3ls">
					...
					<h4 class="agileits w3layouts">Shipping Done</h4>
				</div>
			</div>
			<div class="clearfix"></div>
		</div>
...
<div id="testimonials" class="testimonials">
	<div class="container">
		<h3 class="heading-agileinfo">600+ Happy Clients</h3>
...
<!-- mail -->
				...
				<div class="col-md-7 map ">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3559.456369364975!2d75.76386431452205!3d26.85723798315149!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396db3eed345562d%3A0x227543b9c5e40099!2sBell+Technology!5e0!3m2!1sen!2sin!4v1496819165849" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
				</div>
					<div class="clearfix"></div>
				</div>
<!-- //mail -->
...
<div class="copy">
	<div class="container">
		<h2><a href="index.html"><span>C</span>MS</h2>
